...
object ShoppingSearchModule {
    ...
    @Singleton
    @Provides
    fun provideShoppingSearchPreferencesViewModel(usecase: PreferencesShoppingSiteUseCase): ShoppingSearchPreferencesViewModel =
            ShoppingSearchPreferencesViewModel(usecase)
}